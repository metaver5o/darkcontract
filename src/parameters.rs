...
fn test_parameters() {
    ...
    assert_eq!(
        params.hs[0],
        bls::G1Affine::from_compressed(&[
            0x8b, 0x8a, 0x74, 0xcb, 0xb2, 0x82, 0x27, 0x8d, 0x67, 0x06, 0x6e, 0x05,
            0x96, 0x64, 0x65, 0x50, 0x89, 0x02, 0xb7, 0x82, 0xf1, 0x38, 0x67, 0x7f,
            0x4c, 0xdf, 0xa2, 0xdf, 0xaf, 0xc1, 0xe8, 0x58, 0x6f, 0x71, 0x0a, 0x3c,
            0x57, 0x0d, 0xa4, 0x51, 0x80, 0x7b, 0x43, 0xef, 0x53, 0xa8, 0x18, 0x82,
        ]).unwrap()
    );
    ...
    assert_eq!(
        params.hs[1],
        bls::G1Affine::from_compressed(&[
            0xad, 0x74, 0x9d, 0xcf, 0xee, 0x7a, 0xcf, 0x94, 0xb4, 0x7f, 0xbf, 0x72,
            0xaf, 0x6d, 0x5d, 0xb4, 0x45, 0xa6, 0xd9, 0x08, 0x42, 0xf7, 0x89, 0x26,
            0x19, 0xe5, 0x44, 0xac, 0x32, 0x50, 0x61, 0x1d, 0x9e, 0xbd, 0xe9, 0x77,
            0x76, 0xaf, 0x62, 0xf0, 0xbf, 0xc0, 0xb1, 0xca, 0x48, 0x32, 0xf2, 0xe3,
        ]).unwrap()
    );
}
